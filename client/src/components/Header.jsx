...
const Header = ({ chat }) => {
  ...
  return (
    <div className="flex justify-between !px-4 !py-6 !border-b-2 items-center">
        <div className="flex">
            <ChatBubbleOvalLeftEllipsisIcon className='w-10 h-10 text-blue-600'/>
            <h2 className="font-semibold text-2xl h-10 text-blue-600 ml-2 text-bold">{chat.title}</h2>
        </div>
        <div className="flex">
