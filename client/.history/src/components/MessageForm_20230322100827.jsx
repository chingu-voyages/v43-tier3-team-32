    ...
    <div className="flex justify-center items-center h-24 gap-2">
        ...
        <div className='flex justify-between items-center w-4/5 gap-3 !border-2-blue-600 !px-2'>
            <div className='basis-full relative -top-3'>
                <input 
                    className='absolute top-0 left-0 !z-20 !w-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring--500 block rounded-md sm:text-sm focus:ring-1'
                    type="text"
                    value={message}
